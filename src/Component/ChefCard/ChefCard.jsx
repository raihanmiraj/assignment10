...
const ChefCard = ({id,ChefPicture, ChefName, YearsOfExperience, NumbersOfRecipes, Likes, rating}) => {
    const [viewDetails, setViewDetails] = useState(false);
    return (
        <>
     
             <Link to={`/chef/${id}`} className="flex flex-col gap-3 "   onMouseEnter={() => setViewDetails(true)}
